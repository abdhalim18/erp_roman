...
export function OrdersClient({ initialOrders }: OrdersClientProps) {
    ...
    return (
        <div className="space-y-6">
            ...
            <p className="text-gray-600 mt-2">Kelola pesanan pelanggan dan transaksi</p>
          </div>
          <Button asChild>
          ...
          <Card>
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-medium text-gray-600">Pesanan Tertunda</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-1">Dari semua pesanan</p>
            </CardContent>
          </Card>
            </div>
            ...
            <Card>
              ...
              <div className="flex items-center space-x-2">
                ...
                <CardContent>
                  ...
                  <th className="px-4 py-3 text-left text-sm font-medium text-gray-700">ID Pesanan</th>
                  <th className="px-4 py-3 text-left text-sm font-medium text-gray-700">Pelanggan</th>
                  ...
                  <th className="px-4 py-3 text-right text-sm font-medium text-gray-700">Aksi</th>
                        ...
                        <p className="text-sm mt-1">Coba pencarian lain atau buat pesanan baru</p>
                      </div>
                                        </td>
                                    </tr>
                                ) : (
                        ...
                        {(order as any).customers?.name || 'Tamu'}
                      </td>
                                            <td className="px-4 py-3 text-sm text-gray-600">
                                                {formatDate(order.created_at)}
                                            </td>
                                            <td className="px-4 py-3 text-sm text-gray-600">
                        {(order as any).order_items?.length || 0} item
                      </td>
                                            <td className="px-4 py-3 text-sm font-medium text-gray-900">
            ...
            <CardDescription>Aktivitas pesanan terbaru</CardDescription>
          </CardHeader>
          <CardContent>
                ...
                {recentOrders.map((order) => (
                  <div key={order.id} className="flex items-center justify-between border-b pb-4 last:border-0 last:pb-0">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-gray-500">{(order as any).customers?.name || 'Tamu'}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <CardDescription>Ringkasan status pesanan</CardDescription>
          </CardHeader>
          <CardContent>
